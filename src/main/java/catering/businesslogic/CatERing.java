...
public class CatERing {
    ...
    private CatERing() {
        ...
        //personnelMgr.setUserManager(this.userMgr);
        personnelMgr.addEventReceiver(this.personnelPersistence);
    ...
    public void setPersonnelManager(PersonnelManager personnelMgr) {
        this.personnelMgr = personnelMgr;
    }
