...
public class KitchenSheet extends SummarySheet{
    private ArrayList<KitchenTask> taskList;
    private ArrayList<Assignment> assignmentList;

    public KitchenSheet(Service service, User user) {
        super(service, user);
     ...
     */
    public static ArrayList<KitchenSheet> loadAllSumSheets() {
        return loadSummarySheets("SELECT * FROM KitchenSheets");
    }
     ...
     */
    public static KitchenSheet loadSummarySheetById(int id) {
        ArrayList<KitchenSheet> results = loadSummarySheets("SELECT * FROM KitchenSheets WHERE id = ?", id);
     ...
     */
    public static ArrayList<KitchenSheet> loadSummarySheetsByServiceId(int serviceId) {
        return loadSummarySheets("SELECT * FROM KitchenSheets WHERE service_id = ?", serviceId);
    }

    public static void updateTaskList(KitchenSheet ss) {
    ...
    public static void saveNewSumSheet(KitchenSheet s) {
        String sumSheetInsert = "INSERT INTO KitchenSheets (service_id, owner_id) VALUES (?, ?);";
     ...
     */
    private static ArrayList<KitchenSheet> loadSummarySheets(String query, Object... params) {
        ArrayList<KitchenSheet> summarySheets = new ArrayList<>();
        ...
        PersistenceManager.executeQuery(query, new ResultHandler() {
            ...
            public void handle(ResultSet rs) throws SQLException {
                KitchenSheet s = new KitchenSheet();
                s.id = rs.getInt("id");
        ...
        for (int i = 0; i < summarySheets.size(); i++) {
            KitchenSheet s = summarySheets.get(i);
